...
export default async function handler(req, res) {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.VERCEL_URL || 'https://bridebuddyv2.vercel.app'}/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.VERCEL_URL || 'https://bridebuddyv2.vercel.app'}/paywall.html`,
      metadata: {
        userId,
        weddingId,
